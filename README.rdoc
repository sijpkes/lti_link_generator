...
where plug-ins are turned on and off for individual instructors.
...
This table houses templates for ExpressionEngine.

--
-- Table structure for table `exp_templates`, each entry corresponds to the template files in the templates folder (below).
--
...
=== Development Writable Directory
